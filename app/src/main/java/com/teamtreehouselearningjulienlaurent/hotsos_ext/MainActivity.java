...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_view_completed_order) {
    ...
    @Override
    public void onPendingOrdersFragmentInteraction(Uri uri) {

    }

    @Override
    public void onCompletedOrderFragmentInteraction(Uri uri) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.floatingActionButtonAdd:
                DialogFragment roomNumber = new RoomDialog();
                roomNumber.show(getSupportFragmentManager(), "roomNumber");
            default:
                break;
        }
    }
