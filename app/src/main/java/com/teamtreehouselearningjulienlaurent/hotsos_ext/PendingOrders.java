 ...
 * {@link PendingOrders.OnFragmentInteractionListener} interface
...
public class PendingOrders extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onPendingOrdersFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onPendingOrdersFragmentInteraction(Uri uri);
    }
}
